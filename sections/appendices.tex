...
Accepted regional anchors can optionally be translated into a bounded
adjustment of the acquisition mean.
This component was retained for diagnostic analysis, but it is separate from
the acquisition-restart role described in Section~\ref{sec:region_pref} and is
disabled in the principal Chen2020 configuration.
