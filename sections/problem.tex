...
\subsection{Constrained Multiobjective Charging Objective}
...
the initial temperature, and $Q_s$ is a protocol-level degradation indicator.
All three objectives are minimized. The corresponding nondominated protocols
form the Pareto set, whose image in objective space is the Pareto front.
...
\end{align}
Protocols that violate hard operational constraints receive dominated sentinel
values and are excluded from the feasible Pareto set.
