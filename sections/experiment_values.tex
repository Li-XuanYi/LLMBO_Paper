...
% Reader-facing summary figures and tables in Section V use these same values.
% Chen2020 and Ecker2015 main comparisons retain the five-run statistics from
% the project results manifest. Displayed Chen2020 endpoints refer only to the
% archived seed-8409 center lines in the convergence figure. The component
% ablation uses the matched three-seed archive identified in results_manifest.json.
...
\newcommand{\ChenDisplayedLLMBO}{0.3848}
\newcommand{\ChenDisplayedParEGO}{0.3523}
\newcommand{\ChenDisplayedGain}{9.2\%}
...
% Chen2020 main comparison: five-run final statistics (seeds 8409--8413).
...
% Short-budget Chen2020 component ablation (three matched seeds: 8409--8411,
% 6 initialization evaluations + 10 BO iterations = 16 simulator calls).
