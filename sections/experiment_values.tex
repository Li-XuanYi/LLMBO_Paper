...
% the supplied manuscript; the component ablation uses the supplied three-seed manifest.

\newcommand{\ChenDisplayedLLMBO}{0.3848}
\newcommand{\ChenDisplayedParEGO}{0.3523}
\newcommand{\ChenDisplayedGain}{9.5\%}
...
% Chen2020 main comparison values used by the manuscript-facing figure/table.
